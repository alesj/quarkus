...
class GrpcCompressionInterceptorIntegrationTestBase {
    ...
    private void assertEncoding(boolean gzip, HelloGrpcGrpc.HelloGrpcBlockingStub stub,
            AtomicReference<String> responseEncoding) {
        ...
        assertTrue(
                gzip ? "gzip".equals(encoding) : encoding == null || "identity".equals(encoding),
                gzip ? "Response should be compressed with gzip when client accepts gzip encoding"
                        : "Response should not be compressed when client doesn't specify accept-encoding. Got: " + encoding);
    }
    ...
    void shouldCompressResponseWhenClientAcceptsGzip() {
        ...
        assertEncoding(true, stub, responseEncoding);
    }
    ...
    void shouldNotCompressWhenClientDoesNotSpecifyAcceptEncoding() {
        ...
        assertEncoding(false, stub, responseEncoding);
    }
