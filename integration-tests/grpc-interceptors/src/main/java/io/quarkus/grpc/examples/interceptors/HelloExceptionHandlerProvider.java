...
public class HelloExceptionHandlerProvider implements ExceptionHandlerProvider {
    ...
    @Override
    public StatusRuntimeException transformToStatusRuntimeException(Throwable t) {
        invoked = true;
        if (t instanceof HelloException) {
            ...
            return ExceptionHandlerProvider.toStatusRuntimeException(t);
        }
    }

    private class HelloExceptionHandler<A, B> extends ExceptionHandler<A, B> {
        ...
        protected void handleException(Throwable t, ServerCall<A, B> call, Metadata metadata) {
            StatusRuntimeException sre = transformToStatusRuntimeException(t);
